...
int l=0,m=0,n,total_time=0,g[100],time_quantum;
//delaring the number of processes, iterators, etc.
...
void rr(){
    ...
    for(int i=0;i<total_time;i++){
        ...
        //refreshing the ready queue since time quantum is expired
